...
{
    /// <summary>
    /// There are no comments for TblLnsLensIndexRConfiguration in the schema.
    /// </summary>
    public partial class TblLnsLensIndexRConfiguration : IEntityTypeConfiguration<TblLnsLensIndexR>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<TblLnsLensIndexR> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<TblLnsLensIndexR> builder)
        {
            builder.ToTable(@"Tbl_Lns_LensIndexR", @"dbo");
            ...
            builder.Property(x => x.LensIndexRId).HasColumnName(@"LensIndexRId").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(10, 0);
            ...
            builder.HasKey(@"LensIndexRId");
            builder.HasMany(x => x.TblLnsLensTypeRLensIndexRs).WithOne(op => op.TblLnsLensIndexR).HasForeignKey(@"LensIndexRId").IsRequired(false);
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<TblLnsLensIndexR> builder);
