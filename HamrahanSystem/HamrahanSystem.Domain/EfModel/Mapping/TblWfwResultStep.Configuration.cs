...
{
    /// <summary>
    /// There are no comments for TblWfwResultStepConfiguration in the schema.
    /// </summary>
    public partial class TblWfwResultStepConfiguration : IEntityTypeConfiguration<TblWfwResultStep>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<TblWfwResultStep> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<TblWfwResultStep> builder)
        {
            builder.ToTable(@"Tbl_Wfw_ResultStep", @"dbo");
            builder.Property(x => x.Code).HasColumnName(@"Code").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            builder.Property(x => x.Command).HasColumnName(@"Command").HasColumnType(@"nvarchar(254)").ValueGeneratedNever().HasMaxLength(254);
            builder.Property(x => x.CommandType).HasColumnName(@"CommandType").HasColumnType(@"smallint").IsRequired().ValueGeneratedNever().HasPrecision(5, 0);
            ...
            builder.Property(x => x.ResultStepId).HasColumnName(@"ResultStepId").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(10, 0);
            builder.HasKey(@"ResultStepId");
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<TblWfwResultStep> builder);
