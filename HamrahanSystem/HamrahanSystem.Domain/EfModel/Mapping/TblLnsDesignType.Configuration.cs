...
{
    /// <summary>
    /// There are no comments for TblLnsDesignTypeConfiguration in the schema.
    /// </summary>
    public partial class TblLnsDesignTypeConfiguration : IEntityTypeConfiguration<TblLnsDesignType>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<TblLnsDesignType> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<TblLnsDesignType> builder)
        {
            builder.ToTable(@"Tbl_Lns_DesignType", @"dbo");
            ...
            builder.Property(x => x.DesignTypeId).HasColumnName(@"DesignTypeId").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(10, 0);
            ...
            builder.Property(x => x.SphPlus).HasColumnName(@"SphPlus").HasColumnType(@"bit").IsRequired().ValueGeneratedNever().HasDefaultValueSql(@"0");
            builder.Property(x => x.SphMinus).HasColumnName(@"SphMinus").HasColumnType(@"bit").IsRequired().ValueGeneratedNever().HasDefaultValueSql(@"0");
            builder.Property(x => x.Addition).HasColumnName(@"Addition").HasColumnType(@"bit").IsRequired().ValueGeneratedNever().HasDefaultValueSql(@"0");
            ...
            builder.HasKey(@"DesignTypeId");
            builder.HasMany(x => x.TblLnsBrandDesignTypes).WithOne(op => op.TblLnsDesignType).HasForeignKey(@"DesignTypeId").IsRequired(false);
            builder.HasMany(x => x.TblLnsOrders).WithOne(op => op.TblLnsDesignType).HasForeignKey(@"DesignTypeId").IsRequired(false);
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<TblLnsDesignType> builder);
