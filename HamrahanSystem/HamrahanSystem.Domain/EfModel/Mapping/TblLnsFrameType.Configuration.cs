...
{
    /// <summary>
    /// There are no comments for TblLnsFrameTypeConfiguration in the schema.
    /// </summary>
    public partial class TblLnsFrameTypeConfiguration : IEntityTypeConfiguration<TblLnsFrameType>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<TblLnsFrameType> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<TblLnsFrameType> builder)
        {
            builder.ToTable(@"Tbl_Lns_FrameType", @"dbo");
            ...
            builder.Property(x => x.FrameTypeId).HasColumnName(@"FrameTypeId").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(10, 0);
            ...
            builder.HasKey(@"FrameTypeId");
            builder.HasMany(x => x.TblLnsOrders).WithOne(op => op.TblLnsFrameType).HasForeignKey(@"FrameTypeId").IsRequired(false);
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<TblLnsFrameType> builder);
