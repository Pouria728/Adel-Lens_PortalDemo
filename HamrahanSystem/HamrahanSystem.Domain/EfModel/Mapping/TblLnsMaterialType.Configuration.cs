...
{
    /// <summary>
    /// There are no comments for TblLnsMaterialTypeConfiguration in the schema.
    /// </summary>
    public partial class TblLnsMaterialTypeConfiguration : IEntityTypeConfiguration<TblLnsMaterialType>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<TblLnsMaterialType> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<TblLnsMaterialType> builder)
        {
            builder.ToTable(@"Tbl_Lns_MaterialType", @"dbo");
            ...
            builder.Property(x => x.MaterialTypeId).HasColumnName(@"MaterialTypeId").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(10, 0);
            ...
            builder.HasKey(@"MaterialTypeId");
            builder.HasMany(x => x.TblLnsLensIndexMaterialTypes).WithOne(op => op.TblLnsMaterialType).HasForeignKey(@"MaterialTypeId").IsRequired(false);
            builder.HasMany(x => x.TblLnsOrders).WithOne(op => op.TblLnsMaterialType).HasForeignKey(@"MaterialTypeId").IsRequired(false);
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<TblLnsMaterialType> builder);
