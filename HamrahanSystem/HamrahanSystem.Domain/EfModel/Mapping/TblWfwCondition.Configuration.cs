...
{
    /// <summary>
    /// There are no comments for TblWfwConditionConfiguration in the schema.
    /// </summary>
    public partial class TblWfwConditionConfiguration : IEntityTypeConfiguration<TblWfwCondition>
    {
        /// <summary>
        /// There are no comments for Configure(EntityTypeBuilder<TblWfwCondition> builder) method in the schema.
        /// </summary>
        public void Configure(EntityTypeBuilder<TblWfwCondition> builder)
        {
            builder.ToTable(@"Tbl_Wfw_Condition", @"dbo");
            ...
            builder.Property(x => x.ConditionId).HasColumnName(@"ConditionId").HasColumnType(@"int").IsRequired().ValueGeneratedOnAdd().HasPrecision(10, 0);
        ...
        partial void CustomizeConfiguration(EntityTypeBuilder<TblWfwCondition> builder);
