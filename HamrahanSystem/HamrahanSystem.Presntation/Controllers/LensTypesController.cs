...
{
	[Authorize]
	public class LensTypesController(ITblLnsLensTypeService tblLnsLensTypeService,ICacheService cacheService) : Controller
	{
		...
		[Authorize(Roles = "admin,LensType_Create")]
		[HttpPost]
		public IActionResult Create(TblLnsLensTypeDto tblLnsLensTypeDto)
		{
 			var item= tblLnsLensTypeService.Add(tblLnsLensTypeDto);
			return Json(new
			{
				success = true,
				message = ""
		...
		{
			var item = tblLnsLensTypeService.GetById(id);
		...
		[Authorize(Roles = "admin,LensType_Edit")]
		[HttpPost]
		public IActionResult Edit(TblLnsLensTypeDto tblLnsLensTypeDto)
		{
			var item = tblLnsLensTypeService.Update(tblLnsLensTypeDto);
			return Json(new
			{
				success = true,
				message = ""
        ...
        public IActionResult Delete(int id)
        {
			...
			var item = tblLnsLensTypeService.Delete(id);
			return Json(new
			{
				success = true,
				message = ""
		...
		public JsonResult Detail()
		{
			...
			{
				var prop = typeof(TblLnsLensTypeDto).GetProperty(itemGrid.Sidx, System.Reflection.BindingFlags.IgnoreCase | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
				if (prop != null)
				{
