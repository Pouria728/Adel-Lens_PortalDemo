                    ...
                    for (let item in datasph) {
                        ...
                        for (let itemcyl in datacyllist) {
                            ...
                            if (datamaster.length > 0) {
                                ...
                                if (data.length > 0) {
                                    z.querySelector('[data-kt-element="countlens"]').value = 0;
                                    ...
                                    z.querySelector('[data-kt-element="countlens"]').setAttribute('placeholder', 'sph:' + datasph[item].text + ' cyl: ' + datacyllist[itemcyl].text);
                                    z.querySelector('[data-kt-element="labelcountlens"]').textContent = 'sph:' + datasph[item].text + ' cyl: ' + datacyllist[itemcyl].text;
